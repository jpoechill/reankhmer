    ...
    <main className="h-full font-['Open Sans']">
      ...
      <div className="flex flex-col justify-center mt-20">
        ...
        <div className="w-full flex justify-center">
          ...
          <div className="grid grid-cols-2 w-full max-w-[500px] lg:max-w-[800px] max-auto px-10 lg:grid-cols-4 gap-10 gap-x-0 lg:gap-[60px] mt-10 justify-center text-sm">
      ...
      <div className="mt-[60px] w-full flex flex-col justify-center bg-[url('/footer_bg.jpg')] bg-no-repeat bg-cover bg-center text-white p-11 text-center">
